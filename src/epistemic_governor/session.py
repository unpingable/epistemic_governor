...
try:
    ...
    from epistemic_governor.valve import ValvePolicy, ValveAction, ValveDecision, Anchor
except ImportError:
    from epistemic_governor.kernel import EpistemicKernel, EpistemicFrame, ThermalState
    from epistemic_governor.governor import (
        GenerationEnvelope,
...
class EpistemicSession:
    ...
    def __init__(
        ...
        if enable_shear:
            try:
                from epistemic_governor.shear import ShearAnalyzer
            except ImportError:
                from epistemic_governor.shear import ShearAnalyzer
    ...
    def set_commitment_baseline(self, text: str) -> int:
        ...
        try:
            from epistemic_governor.shear import Commitment
        except ImportError:
            from epistemic_governor.shear import Commitment
    ...
    def check_shear(self, transformed_text: str, transform_type: str = "unknown") -> dict:
        ...
        try:
            from epistemic_governor.shear import TransformType, ShearReport
        except ImportError:
            from epistemic_governor.shear import TransformType, ShearReport
    ...
    def _extract_basic_commitments(self, text: str) -> list:
        ...
        """
        try:
            from epistemic_governor.shear import Commitment, CommitmentType, Modality, Quantifier
        except ImportError:
            from epistemic_governor.shear import Commitment, CommitmentType, Modality, Quantifier
    ...
    def _build_shear_report(self, source, target, transform):
        ...
        try:
            from epistemic_governor.shear import ShearReport, TransportEvidence, TransportStatus
        except ImportError:
            from epistemic_governor.shear import ShearReport, TransportEvidence, TransportStatus
