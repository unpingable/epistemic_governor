...
# V1 imports
from epistemic_governor.claim_extractor import ClaimAtom, ClaimMode, Modality
...
if __name__ == "__main__":
    from epistemic_governor.claim_extractor import Modality, Quantifier
    ...
    from epistemic_governor.symbolic_substrate import Adjudicator, SymbolicState
