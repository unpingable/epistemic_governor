...
def test_withdraw():
    ...
    from epistemic_governor.symbolic_substrate import Predicate, PredicateType, ProvenanceClass
...
def test_supersede():
    ...
    from epistemic_governor.symbolic_substrate import Predicate, PredicateType, ProvenanceClass, SupportItem
    ...
    if result.decision != AdjudicationDecision.ACCEPT:
        ...
        # Force add for test
        from epistemic_governor.symbolic_substrate import Commitment
...
def test_lower_sigma():
    ...
    from epistemic_governor.symbolic_substrate import Predicate, PredicateType, ProvenanceClass, Commitment
