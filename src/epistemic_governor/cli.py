...
try:
    ...
    from epistemic_governor.kernel import EpistemicFrame, ThermalState
    ...
    from epistemic_governor.events import EventLogger
except ImportError:
    from epistemic_governor.session import (
        EpistemicSession,
        create_session,
...
def cmd_calibrate(args):
    ...
    if hasattr(args, 'compare') and args.compare:
        try:
            from epistemic_governor.calibrate import BaselineProfile, compare_profiles
        except ImportError:
            from epistemic_governor.calibrate import BaselineProfile, compare_profiles
...
def cmd_live(args):
    ...
    try:
        from epistemic_governor.session import InstrumentedSession
    except ImportError:
        from epistemic_governor.session import InstrumentedSession
...
def cmd_events(args):
    ...
    try:
        from epistemic_governor.events import load_events, analyze_events, EventType
    except ImportError:
        from epistemic_governor.events import load_events, analyze_events, EventType
...
def cmd_creative(args):
    ...
    try:
        from epistemic_governor.creative import CreativeRegime, CreativeConfig, CreativeMode
    except ImportError:
        from epistemic_governor.creative import CreativeRegime, CreativeConfig, CreativeMode
...
def cmd_registry(args):
    ...
    try:
        from epistemic_governor.registry import create_registry, Domain
...
def cmd_smoke(args):
    ...
    if smoke_path.exists():
        ...
        try:
            from epistemic_governor.registry import create_registry, ProposalEnvelope, StateView, Domain, AuditStatus
...
def cmd_eval(args):
    ...
    try:
        ...
        from epistemic_governor.extractor import CommitmentExtractor
    except ImportError:
        from epistemic_governor.evaluation import (
            EvaluationCorpus,
            ExtractionEvaluator,
...
def cmd_validate(args):
    ...
    try:
        from epistemic_governor.validation import ValidationRunner
    except ImportError:
        from epistemic_governor.validation import ValidationRunner
