...
try:
    from .session import EpistemicSession, create_session, LLMProvider
    from .kernel import EpistemicKernel, EpistemicFrame, ThermalState
    from .governor import GenerationEnvelope, ClaimType
    from .negative_t import NegativeTAnalyzer, Regime, TurnMetrics
    from .valve import ValvePolicy
except ImportError:
    from session import EpistemicSession, create_session, LLMProvider
    from kernel import EpistemicKernel, EpistemicFrame, ThermalState
    from governor import GenerationEnvelope, ClaimType
