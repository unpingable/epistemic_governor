...
try:
    from .session import EpistemicSession, EpistemicFrame
    from .kernel import ThermalState
    from .calibrate import PolicyProfile, DomainPolicy, BaselineProfile, DistributionStats
except ImportError:
    from session import EpistemicSession, EpistemicFrame
    from kernel import ThermalState
    from calibrate import PolicyProfile, DomainPolicy, BaselineProfile, DistributionStats
...
class HomeostaticSession:
    ...
    def _policy_to_envelope(self, policy: DomainPolicy):
        ...
        from governor import GenerationEnvelope, ClaimType
