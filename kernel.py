...
try:
    ...
    from .extractor import CommitmentExtractor, ExtractionConfig
    from .ledger import EpistemicLedger, RevisionRecord
    from .commit_phase import CommitPhase, CommitResult, TransactionStatus
except ImportError:
    from governor import (
        EpistemicGovernor,
        GovernorState,
...
class EpistemicKernel:
    ...
    def build_state_view(self):
        ...
        """
        try:
            from .registry import StateView
        except ImportError:
            from registry import StateView
